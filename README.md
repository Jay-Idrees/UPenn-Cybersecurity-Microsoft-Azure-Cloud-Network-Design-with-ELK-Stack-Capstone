...
- **[install-filebeat.yml](http://scripts/install-filebeat.yml)**
- **[install-metricbeat.yml](http://scripts/install-metricbeat.yml)**
- **[install-elk.yml](http://scripts/install-elk.yml)**
